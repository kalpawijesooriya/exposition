...
public class Gallery extends AppCompatActivity {
    private static final String URL_DATA="https://raw.githubusercontent.com/kalpawijesooriya/aarticals/master/films.txt";
        ...
        StringRequest StringRequest=new StringRequest(Request.Method.GET,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();;
                        Toast.makeText(getApplicationContext(),"Plese check your Internet Conection",Toast.LENGTH_LONG).show();
                    }
                });
